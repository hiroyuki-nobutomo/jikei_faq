...
import { generateCaseId, generateReplyUrl, createCaseRecord, addCaseToThreads, postCaseRecordToBackend } from "./services/threadService";
...
export default function App() {
  ...
  function handleConfirm() {
    ...
    postCaseRecordToBackend(caseRecord);
